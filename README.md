...
<img width="1501" height="1011" alt="image" src="https://github.com/user-attachments/assets/607a654d-0aab-48fd-8947-032dc9f70ebc" />
...
1.	ma (Theory) = am/ac = 5.3 / 10.6 = 0.5
2.	ma(Practical) = (Emax-Emin)/(Emax+Emin) = 10.9 / 21.2 = 0.511
